...
/// CONTRACT LIMITATION:
/// As there is no way I know of to deterministically or conclusively determine the number of tokenIDs an ERC1155 contract will have, the params of this function relies on the known tokenIDs.
...
contract Has1155NFT {
    ...
    /// @return The function returns a 1 if an NFT is found within the search parameters and a 0 if no NFT is found.
